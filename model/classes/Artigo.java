...
public class Artigo implements Serializable {
    ...
    public Artigo(String nome, Fornecedor fornecedor, String descricao) throws Excecao {
    ...
    public Artigo(String nome, Fornecedor fornecedor, String descricao, int stock, int threshold) {
        this.id = UUID.randomUUID().toString();
        this.nome = nome;
        this.fornecedor = fornecedor;
        this.descricao = descricao;
